...
✔ Code Checkout ✔ Trivy Filesystem Scan ✔ OWASP Dependency Check ✔ SonarQube Code Analysis ✔ Docker Image Build ✔ Docker Push to DockerHub

🚀 CD Pipeline (GitOps with ArgoCD)

✔ Update Kubernetes Manifests ✔ Push Changes to GitHub ✔ ArgoCD Auto Sync ✔ Rolling Deployment to AWS EKS ✔ Zero Downtime Deployment
